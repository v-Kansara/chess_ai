...
def main():
    ...
    move_log_font = p.font.SysFont("Sans-Serif", 30, False, False)
...
def drawBoard(screen):
    ...
    """
    global colors
    colors = [p.Color(199, 180, 121), p.Color(102, 41, 14)]
...
def drawMoveLog(screen, game_state, font):
    ...
    p.draw.rect(screen, p.Color(38, 36, 33), move_log_rect)
    ...
    for i in range(0, len(move_texts), moves_per_row):
        ...
        text_object = font.render(text, True, p.Color(219, 215, 208))
